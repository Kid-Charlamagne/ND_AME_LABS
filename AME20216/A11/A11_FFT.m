...
x = load('yourfile.CSV');  % rename 'yourfile.CSV' to correspond with your file name
...
ylabel('Volts/Hz') % this will have units of whatever your measurement variable is
xlabel('frequency (Hz)')
